...
@section('body')
    <!-- <div class="d-flex align-items-center justify-content-between">  -->
        <h1 class="mb-0">Liste des groupes de formations des étudiants</h1><br><br>
        ...
        <input id="myInput" type="text" class="form-control input-text" placeholder="Chercher un étudiant...." aria-label="Recipient's username" aria-describedby="basic-addon2"> <br><br>
            <table class="table table-hover">
                ...
                <tbody id="myTable">
                    @if($etudiantGroupeFormations->count() > 0)
                        @foreach($etudiantGroupeFormations as $egf)
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <form action="/etudiantGroupeFormationDestroy/{{$egf->id}}/0" method="POST" type="button" class="btn btn-danger p-0" onsubmit="return confirm('Delete?')">
                                            @csrf
                        ...
                        @endforeach
                        {{ $etudiantGroupeFormations->links() }}
                    @else
                        <tr>
